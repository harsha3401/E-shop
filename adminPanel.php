                    ...
                    <div class="row">
                                ...
                                <div class="col-6 col-lg-4 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 bg-success text-white text-center rounded" style="height: 100px;">
                                            ...
                                            <br />
                                            <span class="fs-5"><?php echo ($f); ?> Item</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 col-lg-4 px-1">
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                ?>
                                    <div class="col-12 text-center">
                                        <img src="<?php echo ($image_data["code"]); ?>" class="img-fluid rounded-top" style="height: 200px;" />
                                    </div>
                                    <div class="col-12 text-center">
                                        <span class="fs-5 fw-bold"><?php echo ($product_data["title"]); ?></span><br />
                                        <span class="fs-5"><?php echo ($qty_data["qty_total"]); ?> Items</span><br />
                                        <span class="fs-5">Rs. <?php echo ($qty_data["qty_total"] * $product_data["price"]); ?> .00</span>
                                    </div>
                                <?php
                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center">
                                        <img src="<?php echo ($profile_data["path"]); ?>" class="img-fluid rounded-top" style="height: 200px;" />
                                    </div>
                                    <div class="col-12 text-center">
                                        <span class="fs-5 fw-bold"><?php echo ($user_data["fname"] . " " . $user_data["lname"]); ?></span><br />
                                        <span class="fs-5"><?php echo ($user_data["email"]); ?></span><br />
                                        <span class="fs-5"><?php echo ($user_data["mobile"]); ?></span>
                                    </div>
                                    <div class="col-12">
                                        <div class="first-place"></div>
                                    </div>
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center">
                                        <img src="resource/firts-person.ico" class="img-fluid rounded-top" style="height: 200px;" />
                                    </div>
                                    <div class="col-12 text-center">
                                        <span class="fs-5 fw-bold">------</span><br />
