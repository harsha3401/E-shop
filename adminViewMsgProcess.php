...
for ($x = 0; $x < $msg_num; $x++) {
    ...
    if ($msg_data["from"] == $sender_mail && $msg_data["to"] == $reciver_mail) {
...
?>
        ...
        <div class="offset-3 col-9 media mb-3 w-75">
            ...
            ?>
                <div class="offset-11">
                    <img src="<?php echo ($img_data["path"]); ?>" width="30px" class="rounded" />
                </div>
    ...
    } else if ($msg_data["to"] == $sender_mail && $msg_data["from"] == $reciver_mail) {
    ?>
