        ...
        <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="input-group mt-3 mb-3">
                            ...
                            <select class="form-select" style="max-width: 240px;" id="basic_search_select">
                                ...
                                $category_rs = Database::search("SELECT * FROM `category`"); // result set
            ...
            <div class="col-12" id="basicSearchResult">
                <div class="row">
                    ...
                    <center><div class="col-12 d-none d-lg-block  mb-3">
                        <div class="row">

                            <div id="carouselExampleIndicators" class="offset-1 col-10 carousel slide carousel-fade" data-bs-ride="true">
                    ...
                    ?>
                        ...
                        <div class="col-12 mt-3 mb-3 ms-5">
