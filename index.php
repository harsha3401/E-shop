...
<body class="main-body">
    ...
    <div class="col-12 text-end pt-4 pe-4">
        <a href="adminSignin.php" class="btn btn-danger fw-bold fs-6">Go to Admin Login &rarr; </a>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6" id="signUpBox">
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button type="button" class="btn btn-dark" onclick="changeView();">Already have an account? Sign In</button>
                            </div>
                        </div>
                    </div>
