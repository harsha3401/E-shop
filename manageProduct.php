...
<head>
    ...
    <title>Manage Products | Admin | eShop</title>
        ...
        <div class="row mb-5">
            ...
            <div class="col-12 mb-3">
                <div class="row gap-1 justify-content-center">
                    ...
                    ?>
                        <div class="col-12 col-lg-3 border border-danger rounded" style="height: 60px;">
                            <div class="row">
                                <div class="col-8 mt-2 mb-2">
                                    <label class="form-label fw-bold fs-5"><?php echo ($category_data["name"]); ?></label>
                                </div>
                                <div class="col-4 border-start border-secondary text-center mt-2 mb-4">
                    ...
                    <div class="col-12 col-lg-3 border border-success rounded" style="height: 60px;cursor: pointer;" onclick="addNewCategory();">
                        <div class="row">
                            ...
                            <div class="col-4 border-start border-secondary text-center mt-2">
                                <label class="form-label fs-4"><i class="bi bi-plus-square-fill text-success" style="cursor: pointer;"></i></i></label>
                            </div>
                        </div>
                    </div>
