            ...
            ?>
                <div class="col-12 mb-2">
                    <div class="row">
                        ...
                        <div class="col-4 col-lg-2 bg-primary py-2" onclick="viewMsgModel('<?php echo ($selected_data['email']); ?>');" style="cursor: pointer;">
                ...
                <div class="modal" tabindex="-1" id="userMsgModel<?php echo ($selected_data['email']); ?>">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body overflow-scroll" id="chat-box<?php echo ($selected_data['email']); ?>" style="height: 500px;">
                                <!-- received -->
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-3 d-grid">
                                            <button type="button" class="btn btn-primary" onclick="sendAdminMsg1('<?php echo ($selected_data['email']); ?>');">Send</button>
                                        </div>
                                    </div>
                                </div>
