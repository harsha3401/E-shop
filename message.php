                        ...
                        <div class="bg-white">
                            <div class="bg-light px-4 py-2">
                                ...
                                <div class="col-12">
                                    ...
                                    FROM `chat` WHERE `to`='" . $email . "' ORDER BY `date_time` DESC ");
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade message_box" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            ...
                                            $msg_rs2 = Database::search("SELECT DISTINCT `content`,`date_time`,`status`,`to`
                                             FROM `chat` WHERE `from`='" . $email . "' ORDER BY `date_time` DESC ");
                        ...
                        <div class="col-12 px-2">
                            <div class="row">
                                <div class="input-group mb-3">
                                    <input type="text" id="msg_txt" class="form-control rounded border-0 bg-light" placeholder="Type a message ..." aria-describedby="send_btn">
