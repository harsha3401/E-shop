                        ...
                        <div class="col-12 col-lg-4">
                            <div class="row">
                                <div class="col-12 col-lg-4 mt-1 mb-1 text-center">
                                    ...
                                    $Profile_imgage_rs = Database::search("SELECT * FROM `profile_image` WHERE `user_email`='" . $email . "'");
                                    $Profile_imgage_num = $Profile_imgage_rs->num_rows;
                                    $Profile_imgage_data = $Profile_imgage_rs->fetch_assoc();

                                    if ($Profile_imgage_num == 1) {

                                    ?>

                                        <img src="<?php echo ($Profile_imgage_data["path"]) ?>" width="90px" height="90px" class="rounded-circle" />
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                <div class="col-12 col-lg-9 mt-2 my-lg-4">
                                    <h1 class="text-center text-lg-start offset-lg-2 text-white fw-bold">My Products</h1>
                                </div>
                                <div class="col-12 col-lg-3 mx-1 mb-2 my-lg-4 mx-1 mx-lg-0 d-grid">
                                    <button class="btn btn-warning fw-bold p-3" onclick="window.location='addProduct.php'">Add Product</button>
                                </div>
                            </div>
                        </div>
                    </div>
