                ...
                ?>
                    ...
                    <div class="col-12">
                        <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 bg-info text-center text-lg-start">
                                            <label class="form-label text-white fs-6 py-5">0<?php echo ($invoice_data["id"]); ?></label>
                                        </div>
                                        <div class="col-12 col-lg-3">
                                            <div class="card mx-0 mx-lg-3 my-3" style="max-width: 540px;">
                                                <div class="row g-0">
                                                    ...
                                                    ?>
                                                    <div class="col-3 col-md-3 pt-3 pb-3">
                                                    ...
                                                    <div class="col-9 col-md-9">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text"><b>Seller : </b><?php echo ($_SESSION["u"]["fname"]); ?></p>
                                        ...
                                        <div class="col-12 col-lg-2 bg-info text-center text-lg-end">
                                            <label class="form-label text-white fs-6 py-5">Rs. <?php echo ($invoice_data["total"]); ?> .00</label>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid p-2">
                                                    <button class="btn btn-secondary border border-1 fs-5 rounded border-primary mt-4" onclick="addFeedback(<?php echo ($pid); ?>)">
                                                        <i class="bi bi-info-circle-fill"></i> Feedback
                                                    </button>
                                                </div>
                                                <div class="col-6 d-grid p-2">
                                                    <button class="btn btn-danger fs-5 rounded mt-4" onclick="deleteProduct('<?php echo ($pid); ?>');">
                            ...
                            <?php
                            $purchase_rs = Database::search("SELECT * FROM `invoice` WHERE `user_email`='" . $umail . "'");
                            $purchase_num = $purchase_rs->num_rows;

                            for ($x = 0; $x < $purchase_num; $x++) {
                                $purchase_data = $purchase_rs->fetch_assoc();

                                $p_id = $purchase_data["product_id"];

                            ?>
                                <!-- modal -->
                                <div class="modal" tabindex="-1" id="feedbackModal<?php echo ($p_id) ?>">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="saveFeedback(<?php echo ($p_id); ?>);">Save Feedback</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
