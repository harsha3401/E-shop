...
if (isset($_GET["id"])) {
    ...
    product.colour_id,product.status_id,product.condition_id,product.user_email,
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-0 bg-white singleProduct">
                        <div class="row">
                                    ...
                                    <div class="col-lg-4 order-2 order-lg-1 d-none d-lg-block">
                                        <div class="row">
                                            <div class="col-12 align-items-center border border-1 border-secondary">
                                                ...
                                                <img src="<?php echo ($image_data["code"]); ?>" class="img-fluid" id="main-img">
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-12 my-2">
                                                        <div class="row g-2">
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                                                <span class="fs-5 text-primary">Saveen Kudagama</span>
                                                            </div>
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12 mt-5">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-4 d-grid">
                                                                                    <button onclick="addToWatchlist(<?php echo ($pid); ?>);" class="btn btn-secondary">
                                ...
                                <div class="row justify-content-center gap-2">
                                    ...
                                    ?>
                                        ...
                                        <div class="card animation3 col-6 col-lg-3" style="width: 18rem;height: 500px;">
                                            <img src="<?php echo ($im_data["code"]) ?>" class="card-img-top img-fluid img-thumbnail" alt="..." style="height: 180px;" />
                                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                ...
                                                $brand_rs = Database::search("SELECT * FROM `brand` WHERE `id` IN
                                                    (SELECT `brand_id` FROM `brand_has_model` WHERE `id`='" . $product_data["brand_has_model_id"] . "') ");
                                            ...
                                            <div class="col-9">
                                                <label class="form-label fs-4"><?php echo ($brand_data["name"]); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                ...
                                                $model_rs = Database::search("SELECT * FROM `model` WHERE `id` IN
                                                    (SELECT `model_id` FROM `brand_has_model` WHERE `id`='" . $product_data["brand_has_model_id"] . "') ");
                                            ...
                                            <div class="col-9">
                                                <label class="form-label fs-4"><?php echo ($model_data["name"]); ?></label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="row border border-1 border-dark rounded me-0 overflow-scroll" style="height: 330px;">
                                    <div class="col-12 mt-1 mb-1 mx-1">
                                        <div class="row border border-1 border-dark rounded me-0">
                                            ...
                                            <div class="offset-6 col-6 text-end">
                                                <label class="form-label fs-6">2022-11-5 10:30:00</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
