                                ...
                                <div class="col-md-3 border-end">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        ?>
                                            ...
                                            <img src="resource/profile_img/new_user1.svg" id="viewImg" class="rounded mt-5" style="width: 130px;" />
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="mobile" class="form-control" value="<?php echo ($data["mobile"]); ?>" id="mobile"/>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="password" class="form-control" id="npi" value="<?php echo ($data["password"]); ?>" aria-label="Recipient's username" aria-describedby="button-addon2" readonly>
                                            ...
                                            ?>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="mobile" class="form-control" value="<?php echo ($address_data["line1"]); ?>" id="line1"/>
                                                </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label">Address Line 01</label>
                                                    <input type="mobile" class="form-control" id="line1"/>
                                                </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="mobile" class="form-control" value="<?php echo ($address_data["line2"]); ?>" id="line2"/>
                                                </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="col-12">
                                                    <label class="form-label">Address Line 02</label>
                                                    <input type="mobile" class="form-control" id="line2"/>
                                                </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <input type="mobile" class="form-control" value="<?php echo ($address_data["postal_code"]); ?>" id="pcode"/>
                                                </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="col-6">
                                                    <label class="form-label">Postal Code</label>
                                                    <input type="mobile" class="form-control" id="pcode"/>
                                                </div>
